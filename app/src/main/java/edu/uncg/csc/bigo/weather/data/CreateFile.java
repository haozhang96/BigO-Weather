...
public class CreateFile {
    ...
    final public static String sortedFilePath = "/data/user/0/edu.uncg.csc.bigo.weather/files/ZipDirectory/zipSorted.txt";
    final public static String originalFilePath = "/data/user/0/edu.uncg.csc.bigo.weather/files/ZipDirectory/zip.txt";
